...
def search_existing(pb):
    ...
    if choice == 1:
        ...
        query =str(input("Please enter the date of birth of the cntact you wish to search for:"))
        for i in range(len(pb)):
            if query == pb[i][3]:
                check = i
                temp.append(pb[i])
...
def thanks():
    print("******************************************")
    print("Thank you for usin our smartphone directory system!")
...
print("................................................")
print("Hello dear user, welcome to our smartphone dirctory system")
print("You may now proceed to explore this drectoray")
print(".................................................")
